...
function uploadimg()
{
pop("/twoHands/js/uploadimg.jsp","上传图片",300,77)
}


function uploadimg2()
{
pop("/twoHands/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/twoHands/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/twoHands/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/twoHands/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/twoHands/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/twoHands/js/dialogclose.gif  />';
