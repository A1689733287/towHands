																			...
																			<tbody>
																				...
																				<tr>
																					<td width=228 background="twoHands_files/ny_y3.jpg"
																						height="37" align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;已收订单</strong>
																					</td>
						...
						%>
																			<tr>
																				...
																				<td height="27" align="center"><a
																					href="CoreServlet?ac=ufoxg&id=<%=order.getId() %>&uname=<%=session.getAttribute("admin") %>&status=拒绝">拒绝</a>
																					&nbsp;|&nbsp;&nbsp; <a
																					href="CoreServlet?ac=ufoxg&id=<%=order.getId() %>&uname=<%=session.getAttribute("admin") %>&status=发货">发货</a>
																				</td>
																			</tr>
																			<%} %>
																		</table></td>
