...
%>
<body>
	<form action="CoreServlet?ac=nxg&id=<%=news.getId()%>" name="f1" method="post"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								onblur="javascrit:checkform()" id='title' name='title' size=35 /><label
								id='clabeltitle' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class=''
								onblur="javascrit:checkform()" id='author' name='author' size=35 /><label
								id='clabelauthor' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
						...
						<tr>
							<td height="15" colspan="2" align="center" bgcolor="#FFFFFF"
								class="STYLE19"><%=Info.fck(265,news.getContent().toString())%></td>
						</tr>
						<tr>
							<td height="30" colspan="2" align="center" bgcolor="#FFFFFF" class=""><label>
									<input type="submit" name="Submit" value="提交信息" /> &nbsp;&nbsp;&nbsp;
									<input type=button value='返回上页'
									onclick='window.location.replace("CoreServlet?ac=ncx")' />
							</label></td>
						</tr>
					</table></td>
			</tr>
