...
<body>
	<form action="/twoHands/CoreServlet?ac=fxg&id=<%=id%>" name="f1" method="post"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								name='ljname' size=35 /><label id='clabelljname' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								name='ljurl' size=35 /><label id='clabelljurl' /></td>
						</tr>
						<tr>
