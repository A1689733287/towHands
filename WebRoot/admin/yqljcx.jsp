...
function update(no){ 
pop('admin/yqljxg.jsp?id='+no,'信息修改',550,126) 
}
</script>
<script language="javascript"> 
function add(){ 
pop('admin/yqljtj.jsp','信息添加',550,126) 
}
</script>
</head>
<body>
...
%>
	<form action="CoreServlet?ac=flkSearch" name="f1" method="post">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							<td colspan=4 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
								<label></label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;链接名称 &nbsp;:&nbsp; <input
								type=text class='' size=20 name='ljname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;<input type=submit class='' value='查询信息' /> &nbsp;&nbsp;<input
								type=button class='' value='添加信息' onclick="add();" /> &nbsp;&nbsp;
							</td>
						</tr>
						<tr bgcolor="#F3F8F7">
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">链接名称</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">链接地址</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">操作</td>
						</tr>
						<%
for(int i=0;i<list.size();i++){
FriendLink flk=(FriendLink)list.get(i);
 %>
						<tr>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=flk.getLinkname()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=flk.getLinkurl()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a
								href="javascript:update('<%=flk.getId()%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
								onclick="return confirm('确定要删除这条记录吗?')"
								href="/twoHands/CoreServlet?ac=fsc&id=<%=flk.getId()%>">删除</a></td>
						</tr>
						<%}%>
					</table></td>
			</tr>
			<tr>
				<td height="30"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td colspan=4 align="center" class="STYLE19"><%=pageinfo.printCtrl(Page,(String)request.getAttribute("url")) %></td>
						</tr>
					</table></td>
			</tr>
		</table>
