...
if(ljnameobj.value!=""){  
var ajax = new AJAX();
ajax.post("/twoHands/CoreServlet?ac=checkno&table=yqlj&col=ljname&value="+ljnameobj.value+""); 
...
<body>
	<form action="/twoHands/CoreServlet?ac=ftj" name="f1" method="post"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">链接名称</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='ljname'
								name='ljname' onblur="javascript:checkform()" size=35 /><label id='clabelljname' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">链接地址</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='ljurl'
								name='ljurl' onblur="javascript:checkform()" size=35 /><label id='clabelljurl' /></td>
						</tr>
						<tr>
