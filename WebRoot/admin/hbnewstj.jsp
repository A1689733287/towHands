...
<body>
	<form action="/twoHands/CoreServlet?ac=ntj" name="f1" method="post"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">活动标题</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text
								onblur="javascrit:checkform()" class='' id='title' name='title' size=35 /><label
								id='clabeltitle' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">作者</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='author'
								onblur="javascrit:checkform()" name='author' size=35 /><label
								id='clabelauthor' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
