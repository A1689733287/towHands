...
%>
	<form action="CoreServlet?ac=gsSort" name="f1" method="post">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							<td colspan=3 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
								<label></label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;类别名称 &nbsp;:&nbsp; <input
								type=text class='' size=20 name='typename' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tr bgcolor="#F3F8F7">
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">类别名称</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">操作</td>
						</tr>
						<%
for(int i=0;i<list.size();i++){
GoodsSorts gs=(GoodsSorts)list.get(i);
 %>
						<tr>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=gs.getTypename()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a
								href="javascript:update('<%=gs.getId()%>')">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
								onclick="return confirm('确定要删除这条记录吗?')"
								href="/twoHands/CoreServlet?ac=gsc&id=<%=gs.getId()%>">删除</a></td>
						</tr>
						<%}%>
					</table></td>
			</tr>
			<tr>
				<td height="30"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td colspan=3 align="center" class="STYLE19"><%=pageinfo.printCtrl(Page,(String)request.getAttribute("url")) %></td>
						</tr>
					</table></td>
			</tr>
		</table>
...
function update(no){ 
pop('admin/wpflxg.jsp?id='+no,'信息修改',550,97) ;
}
</script>
<script language="javascript"> 
function add(){ 
pop('admin/wpfltj.jsp','信息添加',550,97) ;
}
</script>
