...
<body>
	...
	%>
	<form action="/twoHands/CoreServlet?ac=regedituxg&id=<%=id%>" name="f1"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								onblur="javascrit:checkform()" name='username' size=35 /><label
								id='clabelusername' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">登录密码</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								onblur="javascrit:checkform()" id='email' name='email' size=35 /><label
								id='clabelemail' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">家道地址</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class=''
								onblur="javascrit:checkform()" id='dizhi' name='dizhi' size=35 /><label
								id='clabeldizhi' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
...
<script langtwoHandsscript src='/greensite/js/ajax.js'></script>
<script lantwoHandsascript src='/greensite/js/popup.js'></script>
