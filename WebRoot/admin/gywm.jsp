...
<%
	DataDesc data = (DataDesc) request.getAttribute("data");
%>
<body>
	<form action="/twoHands/CoreServlet?ac=zxg&datatype=关于我们" name="f1"
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width=" " height="30" align="left" bgcolor="#FFFFFF" class="STYLE19"><%=Info.fck(265, data.getContent().toString())%></td>
						</tr>
						<tr>
