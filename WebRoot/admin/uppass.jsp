...
<body>
	<form
		action="/twoHands/CoreServlet?ac=uppass&uname=<%=session.getAttribute("admin") %>"
		name="f1" method="post">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="16%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">请输入原密码</td>
							<td width="27%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19"><label> &nbsp;<input type="password"
									name="olduserpass" />
							</label></td>
						</tr>
						<tr>
							<td width="16%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">请输入新密码</td>
							<td width="27%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp;<input type="password" name="userpass" /></td>
						</tr>
						<tr>
							<td width="16%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">请重复新密码</td>
							<td width="27%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp;<input type="password" name="copyuserpass" /></td>
						</tr>
						<tr>
