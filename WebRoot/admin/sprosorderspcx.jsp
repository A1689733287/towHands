...
%>
	<form action="CoreServlet?ac=oderesSearch" name="f1" method="post">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							<td colspan=11 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
								<label></label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;卖家 &nbsp;:&nbsp; <input
								type=text class='' size=20 name='uname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;订单信息 &nbsp;:&nbsp; <input type=text class='' size=20
								name='ddinfo' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<input type=submit
								class='' value='查询信息' /> &nbsp; &nbsp; &nbsp; <br />
							</td>
						</tr>
						<tr bgcolor="#F3F8F7">
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">卖家</td>
							<td height="30" align="center"
...
Orders orders=(Orders)list.get(i);
 %>
						<tr>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=orders.getTouname()%></td>
							...
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a
								href="/twoHands/CoreServlet?ac=osc&id=<%=orders.getId()%>">删除</a></td>
						</tr>
						<%}%>
					</table></td>
			</tr>
