...
<body>
	<form action="/twoHands/CoreServlet?ac=regedit" name="f1" method="post"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">用户名</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='username'
								name='username' onblur="javascript:chenkform()" size=35 /><label
						...
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">密码</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='userpass'
								onblur="javascrit:checkform()" name='userpass' size=35 /><label
								id='clabeluserpass' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">姓名</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='truename'
								onblur="javascrit:checkform()" name='truename' size=35 /><label
								id='clabeltruename' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">性别</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <span id="sexdanx"><label><input
										type=radio checked=checked name='sex' id='sex' value='男' />&nbsp;男 </label> <label><input
										type=radio name='sex' id='sex' value='女' />&nbsp;女 </label> </span></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">QQ</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='qq' name='qq'
								onblur="javascrit:checkform()" size=35 /><label id='clabelqq' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">电话号码</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='phoneno'
								onblur="javascrit:checkform()" name='phoneno' size=35 /><label
								id='clabelphoneno' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">email</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='email'
								name='email' onblur="javascrit:checkform()" size=35 /><label
								id='clabelemail' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
								class="STYLE19">家庭住址</td>
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text class='' id='dizhi'
								name='dizhi' onblur="javascrit:checkform()" size=35 /><label
								id='clabeldizhi' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!=""){twoHandsajax = new AJAX();
ajax.post("/twoHands/CoreServlet?ac=chenkno&table=users&col=username&value="+usernameobj.value+"");
