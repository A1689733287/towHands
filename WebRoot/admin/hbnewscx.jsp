...
%>
	<form action="CoreServlet?ac=newsSearch" name="f1" method="post">
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							<td colspan=5 height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">
								<label></label>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;新闻标题 &nbsp;:&nbsp; <input
								type=text class='' size=15 name='title' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;作者 &nbsp;:&nbsp; <input type=text class='' size=15
								name='author' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<input
								type=submit class='' value='查询信息' /> &nbsp;&nbsp;<input type=button
								class='' value='添加信息'
								onclick="window.location.replace('admin/hbnewstj.jsp')" /> &nbsp;&nbsp;
							</td>
						</tr>
						<tr bgcolor="#F3F8F7">
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">新闻标题</td>
							<td height="30" align="center"
								style="background-color: #F3F8F7;color:#344B50;">作者</td>
							<td height="30" align="center"
...
News news=(News)list.get(i);
 %>
						<tr>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=news.getTitle()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=news.getAuthor()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><%=news.getSavetime()%></td>
							<td height="30" align="center" bgcolor="#FFFFFF" class="STYLE19"><a
								href="CoreServlet?ac=nncx&id=<%=news.getId()%>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
								onclick="return confirm('确定要删除这条记录吗?')"
								href="/twoHands/CoreServlet?ac=nsc&id=<%=news.getId()%>">删除</a></td>
						</tr>
						<%}%>
					</table></td>
			</tr>
			<tr>
				<td height="30"><table width="100%" border="0" cellspacing="0"
						cellpadding="0">
						<tr>
							<td colspan=5 align="center" class="STYLE19"><%=pageinfo.printCtrl(Page,(String)request.getAttribute("url")) %></td>
						</tr>
					</table></td>
			</tr>
		</table>
