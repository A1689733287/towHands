...
%>
<body>
	<form action="/twoHands/CoreServlet?ac=regeditmxg&id=<%=id%>" name="f1"
				...
				<td><table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								...
								name='username' onblur="javascrit:checkform()" size=35 /><label
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp; <input type=text
								onblur="javascrit:checkform()" class='' id='email' name='email' size=35 /><label
								id='clabelemail' /></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
