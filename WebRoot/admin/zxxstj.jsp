...
var wptypeobj = document.getElementById("lxaddrs");  
if(wptypeobj.value==""){  
document.getElementById("clabellxaddrs").innerHTML="&nbsp;&nbsp;<font color=red>请输入联系地址</font>";  
return false;  
}else{
document.getElementById("clabelwptype").innerHTML="  ";  
}  
...
<body>
	<form action="/twoHands/CoreServlet?ac=twotj" name="f1" method="post"
